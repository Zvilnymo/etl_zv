...
_UPSERT_SQL = """
    INSERT INTO crm.fact_invoices (
        ...
        date_create, date_modify, invoice_date, payment_date, moved_time, payment_description,
        ...
        %(date_create)s, %(date_modify)s, %(invoice_date)s, %(payment_date)s, %(moved_time)s, %(payment_description)s,
